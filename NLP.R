...
#(i in 1:10) is a page no 1 to 10 -> i is a page number, sep-sepration between page no and url
#html_nodes is a url, html_text will search for url
#rev - 1st it will serach for 1st page will save in amazon_reviews and will search for next page
